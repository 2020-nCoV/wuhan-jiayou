...
; 💖武汉加油，中国加油🇨🇳 for Philips Videopac (Magnavox Odyssey 2)
...
start:
	...
	mov	r3,#40                          ; x
	mov	r4,#100                         ; y
	mov	r1,#Lovestr & 0ffh             ; string to print (should be on same 255 bytes page)
...
; '💖武汉加油，中国加油🇨🇳' (ascii not supported by assembler)
Lovestr:
